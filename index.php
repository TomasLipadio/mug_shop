				...
				<div id="content">
					...
					<?php
                        ...
                        for ($i=0; $i<count($productarticles); $i++){
							echo '
								<div id="product">
								 <p><img src="products/',$productimgs[$i],'" alt="',$productnames[$i],'"></p>
								 <br>
								 <p align="middle">',$productnames[$i],'</p>
								 <br>
							 ...
							 if (isset($_SESSION['login']) && isset($_SESSION['adminmode'])) {
								 ...
								 <center><input type="submit" value="Удалить товар" onclick="return confirmDelete();"  name="product',$i,'"/></center>
								 </form>';
							 }
							 else{
								 ...
								 for ($j=0; $j<$_SESSION['basketcounter']; $j++){
									if ($_SESSION['item'.$j]==$productarticles[$i]){
										echo '<center><input type="submit" value="Добавлено в корзину" name="product', $i, '" disabled></center> ';
										$is_item_added[$i]=true;
									}
								 }
								 if ($is_item_added[$i]==false){
									echo ' <center><input type="submit" value="Добавить в корзину" name="product', $i, '"></center>';
								 }
						 ...
						 if (isset($_SESSION['login']) && isset($_SESSION['adminmode']))
						 {
							 ...
							 <input type="submit" style="width:200px; height:50px; font-size:22px;" value="Добавить товар">
							 </form>
							 </div>';
						 }			
                     ?>

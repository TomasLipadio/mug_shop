            ...
            <div id="content">
               <div id="catalog">
                  ...
                  <div id="new_order" style="background:none;">
                     <?php $logins=file('files/orderslogins_9jd2U9d2uqxDk29dqUsj2.txt', FILE_IGNORE_NEW_LINES);
                        $fullnames=file('files/ordersfullnames_9jd2U9d2uqxDk29dqUsj2.txt', FILE_IGNORE_NEW_LINES);
                        $phonenumbers=file('files/ordersphonenumbers_9jd2U9d2uqxDk29dqUsj2.txt', FILE_IGNORE_NEW_LINES);
